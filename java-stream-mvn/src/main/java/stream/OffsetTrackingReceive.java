...
public class OffsetTrackingReceive {
    public static void main(String[] args) throws InterruptedException {
        try (Environment environment = Environment.builder().requestedHeartbeat(Duration.ofSeconds(5)).build()) {
            ...
            System.out.printf("Done consuming, first offset %d, last offset %d.%n", firstOffset.get(), lastOffset.get());
        }
    }
}
